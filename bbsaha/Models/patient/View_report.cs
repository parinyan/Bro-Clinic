...
namespace bbsaha.Models.patient
{
    public class View_report
    {
        ...
        public string sgot { get; set; }
            ...
            public int medtyse { get; set; }
            public int paytyse { get; set; }
            public int moneyse { get; set; }
            public string remarkse { get; set; }
            public string repaydatese { get; set; }
            public string rededatese { get; set; }
            public string reccomse { get; set; }
            public decimal totalse { get; set; }
            public bool chksellist { get; set; }
